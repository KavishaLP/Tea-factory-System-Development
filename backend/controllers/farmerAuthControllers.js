...
export const fmrForgotPassword = (req, res) => {
...
export const fmrSendAgain = (req, res) => {
    const { email } = req.body;
    console.log(req)
...
export const fmrCheckCode = (req, res) => {
...
export const fmrUpdatePassword = (req, res) => {

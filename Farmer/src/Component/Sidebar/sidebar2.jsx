...
const Sidebar2 = () => {
    ...
    return (
        <div className="sidebar">
            ...
            <div className="sidebar-item-custom" onClick={() => navigate("/teasack")}>
                <FaLeaf className="sidebar-icon" /> <p>Tea Sack Update</p>
            </div>
            <div className="sidebar-item-custom" onClick={() => navigate("/advance-update")}>
                <FaHandHoldingUsd className="sidebar-icon" /> <p>Advance Update</p>
            </div>
            <div className="sidebar-item-custom" onClick={() => navigate("/tea-packet-distribution")}>
                <FaBox className="sidebar-icon" /> <p>Tea Packet Distribution</p>
            </div>
            <div className="sidebar-item-custom" onClick={() => navigate("/settings")}>
